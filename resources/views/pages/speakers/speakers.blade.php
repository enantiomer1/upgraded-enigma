            ...
            <div class="col-md-6">
                <div class="card mb-4 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.speakers.index') }}" class="btn btn-sm btn-outline-warning">All Tapes</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card mb-4 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.speakers.index') }}" class="btn btn-sm btn-outline-warning">Top 50 Tapes</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card mb-4 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.speakers.index') }}" class="btn btn-sm btn-outline-warning">Sandy Beach</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card mb-4 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.speakers.index') }}" class="btn btn-sm btn-outline-warning">Joe and Charlie</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card mb-4 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.speakers.index') }}" class="btn btn-sm btn-outline-warning">Clarence Snyder</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card mb-4 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.speakers.index') }}" class="btn btn-sm btn-outline-warning">Funny Tapes</a>
                    </div>
                </div>
            </div>
        </div>
